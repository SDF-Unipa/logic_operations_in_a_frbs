# Plots mean Kendall τ ± std vs. perturbation level for Example 1.
# Reads tolerances_summary.json produced by sensitivity_analysis_example_1.py.
...
SUMMARY_PATH = Path(__file__).with_name("example_1_metadata") / "tolerances_summary.json"
OUTPUT_PATH = Path(__file__).with_name("example_1_metadata") / "sensitivity_plot.png"
...
def main() -> None:
    ...
    ax.set_title("Robustness Analisys for Example 1", fontsize=12)
    ax.set_xticks(pcts)
