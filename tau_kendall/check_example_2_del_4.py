# Larsen inference for Example 2 with rule R4 removed.
# Rule R4: IF IT IS Low AND PT IS Medium AND EN IS Medium AND VRAM IS High AND OSS IS Low THEN Weight IS Very Low.
