# Larsen inference for Example 1 with rule R4 removed.
# Rule R4: IF Italian IS Low AND Portuguese IS High THEN Weight IS Very Low.
# Removing one rule at a time and comparing the resulting ranking to the full-rule
# baseline (via Kendall τ) measures structural sensitivity to each rule's presence.
import csv
