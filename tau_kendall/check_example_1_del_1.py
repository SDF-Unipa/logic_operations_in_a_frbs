# Larsen inference for Example 1 with rule R1 removed.
# Rule R1: IF Italian IS High AND Portuguese IS High THEN Weight IS Very High.
# Removing one rule at a time and comparing the resulting ranking to the full-rule
# baseline (via Kendall τ) measures how sensitive the ranking is to each rule's
# presence — a structural sensitivity analysis complementary to the score perturbations
# in sensitivity_analysis_example_1.py.
import csv
